...
class UserController extends Controller
{
    ...
    public function getCurrentUserData() {
        ...
        $json = $serializer->serialize($user, 'json', ['attributes' => ['id', 'email', 'firstName', 'address', 'phoneNumber', 'lastName',
            'addresses' => ['id', 'address', 'city' => ['id', 'cityName'], 'courierService' => ['id', 'courierServiceName']], 'requests' => ['id', 'isAccepted', 'isReadByReceiver', 'isReadByRequester', 'requester' => ['id'], 'receiver' => ['id'], 'requestedBook' => ['id', 'title', 'author', 'description', 'publisher', 'datePublished', 'pages', 'imageURL', 'rating']]
            ]
        ]);
